...
class HttpReplicator{
	...
	/**
	 * Recupera as responses retornadas pelas url's que receberam a replicação da requisição
	 * @return array:string
	 */
	...
	public function replicateTo($url){
		...
		//Guarda no arranjo de responses
	...
	private function sendHttpRequest($url, $httpBody, $arrCurlHeaders){
		...
		try{
			...
			//O Curl precisa de um ponteiro para mandar as responses
