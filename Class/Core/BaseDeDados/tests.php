...
require_once __DIR__ . '/CCarregadorDeObjetos.php';

$c = new CCarregadorDeObjetos(CConfiguracao::CONST_BD_NOME_PESSOAS);

$c->getIdsDeUsuarioViaLoginESenha("tatupheba","tatu7");
