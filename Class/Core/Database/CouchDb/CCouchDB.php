...
class CCouchDB extends CCore{
	...
	private function generateRequest($url, $requestType, $documentId = null, $information = null, $rev = null) {
		...
		$req = "{$requestType} {$urlCompleta} HTTP/1.0\r\nHost: " . CConfiguration::CONST_DB_HOST_ADDRESS . "\r\n";

		if(CConfiguration::CONST_DB_LOGIN){
			$req .= 'Authorization: Basic ' . base64_encode(CConfiguration::CONST_DB_LOGIN . ':' . CConfiguration::CONST_DB_PASSWORD) . "\r\n";
		}
	...
	protected function send($requestType, $url, $documentId = null, $information = null, $rev = null){
		...
		$ponteiro = fsockopen(CConfiguration::CONST_DB_HOST_ADDRESS, CConfiguration::CONST_DB_PORT, $errno, $errstr);
