 ...
 */
class WsV3DbOperations implements IDataBaseOperations{
	...
	public function openConnection(){
		$this->wsClient = new SoapClient(Configuration::CONST_WS_V3_DATABASE_URL, array("trace" => 0, "exceptions" => 1, "user_agent"=>""));
	}
	...
	public function execQuery($query){
		try{
			...
			$return = $this->wsClient->executeProcedure(Configuration::CONST_WS_V3_DBOPERATIONS_CLASS, $query);
	...
	public function getProcedureCallToken(){
		return Configuration::CONST_WS_V3_DATABASE_PROCEDURE_CALL_TOKEN;
	}
}
?>