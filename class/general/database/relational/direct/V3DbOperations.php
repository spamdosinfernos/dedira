...
/**
 * Operações do banco de dados para o servidor V3
 */
class V3DbOperations implements IDataBaseOperations{
	...
	public function openConnection(){
		$dsn = "pgsql:host=" . Configuration::CONST_V3_DATABASE_URL . ";dbname=" . Configuration::CONST_V3_DATABASE_BASENAME_INTEGRACAO . ";port=" . Configuration::CONST_V3_DATABASE_PORT;
		$this->conexao = new PDO($dsn, Configuration::CONST_V3_DATABASE_USER, Configuration::CONST_V3_DATABASE_PASSWORD);
	...
	public function getProcedureCallToken(){
		return Configuration::CONST_V3_DATABASE_PROCEDURE_CALL_TOKEN;
	}
}
?>