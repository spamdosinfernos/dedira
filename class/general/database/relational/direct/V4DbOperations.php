 ...
 */
class V4DbOperations implements IDataBaseOperations{
	...
	public function openConnection(){
		$dsn = "mysql:host=" . Configuration::CONST_V4_DATABASE_URL . ";dbname=" . Configuration::CONST_V4_DATABASE_BASENAME_SCA . ";port=" . Configuration::CONST_V4_DATABASE_PORT;
		$this->conexao = new PDO($dsn, Configuration::CONST_V4_DATABASE_USER, Configuration::CONST_V4_DATABASE_PASSWORD);
	...
	public function getProcedureCallToken(){
		return Configuration::CONST_V4_DATABASE_PROCEDURE_CALL_TOKEN;
	}
}
?>