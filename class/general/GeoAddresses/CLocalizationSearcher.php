...
require_once __DIR__ . '/../configuration/CLocalizationSearcherConf.php';
/**
...
class LocalizationSearcher {
	...
	private function searchCepLivre($cep) {
		...
		$this->addressData->load(CLocalizationSearcherConf::getCepLivreUrl() . $cep);
	...
	private function searchCepUnico($cep){
		...
		$this->addressData->load(CLocalizationSearcherConf::getCepUnicoUrl() . $cep);
