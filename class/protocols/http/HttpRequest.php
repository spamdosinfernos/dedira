...
class HttpRequest {
	 ...
	 * @var array:string
	 */
	private $arrAditionalHeaders = array (
			'CONTENT_TYPE',
			'CONTENT_LENGTH' 
	);
	 ...
	 * 
	 * @param
	 *        	array:string - nomes dos cabeçalhos adicionais a serem recuperados
	 */
	...
	public function getPostRequest($queryStringVarName = null) {
		if (is_null ( $queryStringVarName )) return $this->postRequest;
		
		return isset ( $this->postRequest [$queryStringVarName] ) ? array (
				$this->postRequest [$queryStringVarName] 
		) : null;
	}
	...
	public function getGetRequest($queryStringVarName = null) {
		...
		return isset ( $this->getRequest [$queryStringVarName] ) ? array (
				$this->getRequest [$queryStringVarName] 
		) : null;
	}
}
?>
